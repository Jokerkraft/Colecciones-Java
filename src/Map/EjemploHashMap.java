...
public class EjemploHashMap {
    public static void main(String[] args) {
        ...
        String ciudadd = direccionPersona.get("ciudad");
        String barrio = direccionPersona.getOrDefault("barrrio","La playa");
        System.out.println("El país de " + nombre + " es: " + pais);
        System.out.println("La ciudad de " + nombre + " es: " + ciudadd);
        ...
        b2 = persona.containsValue("john.doe@gmail.co");
        System.out.println("b2 = " + b2);
        ...
        for(String llave: persona.keySet()){
            ...
            if(valor instanceof Map){
                String nom = (String) persona.get("nombre");
                Map<String,String> direccionMap = (Map<String,String>) valor;
                System.out.println("El pais de " + nom  + ": " + direccionMap.get("país"));
        ...
        System.out.println("contiene elementos = " + !persona.isEmpty());
        boolean b3 = persona.replace("nombre","John","Oskar");
