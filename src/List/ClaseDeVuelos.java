...
public class ClaseDeVuelos {
    public static void main(String[] args) throws ParseException {
        ...
        llegadas.sort((v1,v2) -> v2.getFecha_hora().compareTo(v1.getFecha_hora()));

        llegadas.forEach(System.out::println);
        Vuelo ultimoVuelo = llegadas.get(0);
        System.out.println("El último vuelo en llegar es " + ultimoVuelo.getNombre() + ": " + ultimoVuelo.getOrigen() + ", aterriza el " + ultimoVuelo.getFecha_hora());

        llegadas.sort((v1,v2) -> Integer.valueOf(v2.getCantidad_pasajeros()).compareTo(v1.getCantidad_pasajeros()));
        Vuelo vueloMenor = new LinkedList<>(llegadas).peekLast();
        System.out.println("El vuelo con menor número de pasajeros es " + vueloMenor.getNombre() + ": " + vueloMenor.getOrigen() + ", con " +vueloMenor.getCantidad_pasajeros() + " pasajeros");
